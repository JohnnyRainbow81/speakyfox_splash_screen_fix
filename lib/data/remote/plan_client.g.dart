...
class _PlanClient implements PlanClient {
  _PlanClient(this._dio, {this.baseUrl});
  ...
  @override
  Future<Response<List<PaymentMethodDto>>> getPaymentMethodsByPlanId(
      planId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<Response<List<PaymentMethodDto>>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '${planId}/payment-methods',
