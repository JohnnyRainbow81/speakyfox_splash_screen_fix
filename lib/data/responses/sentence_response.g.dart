...
part of 'sentence_response.dart';
...
SentenceResponse _$SentenceResponseFromJson(Map<String, dynamic> json) =>
    SentenceResponse(
      ...
      sourceHighlightedParts: (json['sourceHighlightedParts'] as List<dynamic>)
          .map((e) =>
              HighlightedPartResponse.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$SentenceResponseToJson(SentenceResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
